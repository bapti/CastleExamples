...
{
    public class CommandPattern_Explicit_Tests
    {
        private readonly CommandProcessor sut;

        public CommandPattern_Explicit_Tests()
        {
            ...
            container.Register(
                Component
                    ...
                    .ImplementedBy(typeof(LoggingDecorator<AccelerateCommand>))
                    .LifestyleTransient(),

                Component
                    .For(typeof(ICommandHandler<AccelerateCommand>))
                    .ImplementedBy(typeof(TimingDecorator<AccelerateCommand>))
                    .LifestyleTransient(),
